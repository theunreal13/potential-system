...
const Inicio = (props) => {
  return (
    <div className={styles['container']}>
      ...
      <header data-role="Header" className={projectStyles['header']}>
        <img
          alt="logo"
        ...
        <div data-type="MobileMenu" className={styles['MobileMenu']}>
          <div className={styles['Nav1']}>
            <div className={styles['Container1']}>
              ...
              />
              <div data-type="CloseMobileMenu" className={styles['MenuClose']}>
      ...
      <div className={styles['Hero']}>
        <h1 className={styles['text']}>Inxplora tu mundo</h1>
      ...
      <div className={styles['Banner']}>
        <h1 className={styles['text05']}>Ultim para todos</h1>
        ...
        <div className={styles['BtnGroup2']}>
          <button
            className={` ${styles['button2']} ${projectStyles['button-secondary']} ${projectStyles['button']} `}
          >
            Get Started
          </button>
          <button
