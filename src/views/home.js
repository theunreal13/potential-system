    ...
    <div className={styles['container']}>
      ...
      <header data-role="Header" className={styles['Header']}>
        ...
        <div className={styles['BtnGroup']}>
          <button
            className={` ${styles['Spanish']} ${projectStyles['button']} ${projectStyles['button-two']} `}
          >
            Español
          </button>
          <Link
            to="/un-services"
            className={` ${styles['UnServices']} ${projectStyles['button']} `}
          >
      ...
      <div className={styles['Hero']}>
        <h1 className={styles['text03']}>Unxplore your world</h1>
      ...
      <div className={styles['Banner']}>
        <h1 className={styles['text08']}>Ultim for everyone</h1>
        ...
        <div className={styles['BtnGroup2']}>
          <button
            className={` ${styles['button2']} ${projectStyles['button']} ${projectStyles['button-two']} `}
          >
            Get Started
          </button>
          <button
