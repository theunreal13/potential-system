  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>Inicio - The Unreal 13</title>
          <meta property="og:title" content="Inicio - The Unreal 13" />
        </Head>
        <header data-role="Header" className="header">
          ...
          <div className="btn-group">
            <button className="login button">English</button>
            <button className="button">Descubre UnServices</button>
          </div>
        ...
        <div className="hero">
          <h1 className="text">Inxplora tu mundo</h1>
          <span className="text01">
            <span>
              <span>Bienvenido al mundo de los visionarios</span>
            </span>
            <span></span>
          </span>
        ...
        <div className="banner">
          <h1 className="text05">Ultim para todos</h1>
          ...
          <div className="btn-group2">
            <button className="button2 button-secondary button">
              Get Started
            </button>
        ...
        {`
          ...
          .hero {
            ...
            background-image: linear-gradient(
                90deg,
                rgb(241, 242, 181) 0%,
                rgba(19, 80, 88, 0.5) 100%
              ),
              url('https://images.unsplash.com/photo-1486546910464-ec8e45c4a137?ixid=Mnw5MTMyMXwwfDF8c2VhcmNofDEzfHxBYnN0cmFjdHxlbnwwfHx8fDE2NDYyNDg4Mjc&ixlib=rb-1.2.1&w=1500');
          }
          .text {
