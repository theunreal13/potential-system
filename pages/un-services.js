    ...
    <>
      <div className="container">
        ...
        <header data-role="Header" className="header">
          <img
            alt="logo"
            src="f2398c56-af42-40eb-aa36-34970fb8b706"
            loading="eager"
            className="image"
          />
          <div className="nav">
          ...
          <div className="btn-group">
            <button className="spanish button-secondary button">Español</button>
        ...
        <div className="hero">
          <h1 className="text3">UnDiscover what moves you</h1>
        ...
        {`
          ...
          .hero {
            ...
            background-image: linear-gradient(
                90deg,
                rgb(192, 36, 37) 0%,
                rgba(240, 203, 53, 0.8) 100%
              ),
              url('https://images.unsplash.com/photo-1646313313262-5fd543a7337d?ixid=Mnw5MTMyMXwwfDF8YWxsfDE4fHx8fHx8Mnx8MTY0NjMyMjk2MQ&ixlib=rb-1.2.1&w=1500');
          }
          .text3 {
